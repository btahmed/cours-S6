...
\begin{exemple}
\textbf{Exercice 3 -- Methode a deux phases (probleme a deux variables)}

Resoudre par la methode du simplexe a deux phases :
\begin{align*}
\text{maximiser} \quad & z = -2x_1 - x_2\\
\text{sujet a} \quad & -x_1 + x_2 \leq -1\\
& x_1 - 2x_2 \leq 4\\
& x_1, x_2 \geq 0
\end{align*}
...
\begin{enumerate}
    \item Identifier pourquoi l'origine n'est pas realisable.
    \item Former le probleme auxiliaire et construire le premier dictionnaire realisable.
    \item Resoudre la Phase 1.
    \item Deduire le dictionnaire de depart pour la Phase 2 et trouver la solution optimale.
\end{enumerate}
\end{exemple}

\begin{exemple}
\textbf{Exercice 4 -- Probleme avec variables artificielles}
...
\begin{exemple}
\textbf{Exercice 5 -- Regle de Bland}
